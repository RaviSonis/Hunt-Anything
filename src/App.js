...
class App extends React.Component {
  ...
  changeselect = (event) => {
    ...
    console.log("the selected movie is " + this.state.selectedMovie + " and id is " + event) 
  }
selectnone = () => {
  ...
  componentDidMount()  {
    ...
    async function fetchMyAPI() {
      let url = `https://www.omdbapi.com/?s=thor&apikey=a9118a3a`;
      console.log(url);
...
const currentPost = this.state.movieList.slice(indexOfFirstPost,indexOfLastPost)
...
const check = () => console.log(this.selectedMovie)
  return (
    <Container>
      ...
      <Pagination
        postsPerPage={this.state.postPerPage} totalPosts = {this.state.movieList.length} paginate={paginate}>
