...
componentDidMount() {
  ...
  render() {
    var { selectedMovie } = this.props.selectedMovie;
    const { Title, Year, Type, Poster,imdbRating,Language,Rated,Released,Runtime,Genre,Director,Actors,Plot } = this.state.movieInfo;
      ...
      {this.state.movieInfo ? (
        <>
          ...
          <InfoColumn>
            ...
            <Trailer class="button-81" onClick={onClickUrl(`https://www.youtube.com/results?search_query=${Title}+trailer`)}>
            Trailer
            </Trailer>
